    ...
    public class HapticsGUI : MonoBehaviour
    {
        ...
        private void DrawXToysTab(float y)
        {
            ...
            string[] guide =
            {
                ...
                "  3.  Open  BepInEx/config/com.rustyblu.7dtd_haptics.cfg  and paste it into:  XToys.WebhookId = <paste here>",
                "  4.  Set  XToys.Enabled = true  in the same file, then restart the game (or toggle Enable above)",
                "  5.  At xtoys.app, search the script library for  '7DTD Haptics'  (by RustyBlu)  and load it.",
